...
public class AlertDialogLayout extends C1101pa {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (!m4401a(widthMeasureSpec, heightMeasureSpec)) {
            super.onMeasure(widthMeasureSpec, heightMeasureSpec);
        }
    }

    /* renamed from: a */
    private boolean m4401a(int widthMeasureSpec, int heightMeasureSpec) {
        int childHeightSpec;
        ...
        for (int i3 = 0; i3 < count; i3++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0793R.C0794id.topPanel) {
                    topPanel = child;
                } else if (id == C0793R.C0794id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C0793R.C0794id.contentPanel && id != C0793R.C0794id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }
        ...
        if (buttonPanel != null) {
            ...
            buttonHeight = m4400a(buttonPanel);
    ...
    /* renamed from: a */
    private static int m4400a(View v) {
        int minHeight = C0646w.m2975i(v);
        if (minHeight > 0) {
            return minHeight;
        }
    ...
    public void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        while (i3 < count) {
            ...
            if (child == null || child.getVisibility() == 8) {
                ...
                int a = C0623f.m2881a(layoutGravity, layoutDirection) & 7;
