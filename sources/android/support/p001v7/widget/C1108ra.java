...
public class C1108ra extends C0994s {
    ...
    public C1108ra(Context context) {
    ...
    /* access modifiers changed from: protected */
    public void onSeekTargetStep(int dx, int dy, C0997t state, C0995a action) {
        if (getChildCount() == 0) {
            stop();
            return;
        }
    ...
    /* access modifiers changed from: protected */
    public void updateActionForInterimTarget(C0995a action) {
        PointF scrollVector = computeScrollVectorForPosition(getTargetPosition());
        if (scrollVector == null || (scrollVector.x == 0.0f && scrollVector.y == 0.0f)) {
            action.mo7941a(getTargetPosition());
            stop();
            return;
        }
        ...
        action.mo7942a((int) (((float) this.mInterimTargetDx) * TARGET_SEEK_EXTRA_SCROLL_RATIO), (int) (((float) this.mInterimTargetDy) * TARGET_SEEK_EXTRA_SCROLL_RATIO), (int) (((float) calculateTimeForScrolling(10000)) * TARGET_SEEK_EXTRA_SCROLL_RATIO), this.mLinearInterpolator);
    }
    ...
    public int calculateDyToMakeVisible(View view, int snapPreference) {
        C0981i layoutManager = getLayoutManager();
    ...
    public PointF computeScrollVectorForPosition(int targetPosition) {
        ...
        if (layoutManager instanceof C0996b) {
            return ((C0996b) layoutManager).computeScrollVectorForPosition(targetPosition);
        }
        StringBuilder sb = new StringBuilder();
        sb.append("You should override computeScrollVectorForPosition when the LayoutManager does not implement ");
        sb.append(C0996b.class.getCanonicalName());
