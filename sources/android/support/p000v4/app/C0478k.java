...
public class C0478k extends Fragment implements OnCancelListener, OnDismissListener {
    ...
    public void show(C0486t manager, String tag) {
        this.mDismissed = false;
        this.mShownByMe = true;
        C0424G ft = manager.mo4909a();
        ft.mo5037a((Fragment) this, tag);
        ft.mo5032a();
    }

    public int show(C0424G transaction, String tag) {
        this.mDismissed = false;
        this.mShownByMe = true;
        transaction.mo5037a((Fragment) this, tag);
        this.mViewDestroyed = false;
        this.mBackStackId = transaction.mo5032a();
        return this.mBackStackId;
    }

    public void showNow(C0486t manager, String tag) {
        this.mDismissed = false;
        this.mShownByMe = true;
        C0424G ft = manager.mo4909a();
        ft.mo5037a((Fragment) this, tag);
    ...
    public void dismissInternal(boolean allowStateLoss) {
        if (!this.mDismissed) {
            ...
            if (this.mBackStackId >= 0) {
                getFragmentManager().mo4910a(this.mBackStackId, 1);
                this.mBackStackId = -1;
            } else {
                C0424G ft = getFragmentManager().mo4909a();
                ft.mo5043c(this);
                if (allowStateLoss) {
                    ft.mo5039b();
                } else {
    ...
    public LayoutInflater onGetLayoutInflater(Bundle savedInstanceState) {
        ...
        if (dialog == null) {
            return (LayoutInflater) this.mHost.mo5227c().getSystemService(str);
        }
