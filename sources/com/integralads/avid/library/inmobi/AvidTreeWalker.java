...
public class AvidTreeWalker implements IAvidViewWalker {
    ...
    /* access modifiers changed from: 0000 */
    public void setAdViewCache(AvidAdViewCache avidAdViewCache) {
        this.adViewCache = avidAdViewCache;
    }

    /* access modifiers changed from: 0000 */
    public void setStatePublisher(AvidStatePublisher avidStatePublisher) {
        this.statePublisher = avidStatePublisher;
    }

    /* access modifiers changed from: 0000 */
    public void setProcessorFactory(AvidProcessorFactory avidProcessorFactory) {
