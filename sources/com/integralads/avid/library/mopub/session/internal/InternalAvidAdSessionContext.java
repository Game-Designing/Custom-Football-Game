...
public class InternalAvidAdSessionContext {
    ...
    public InternalAvidAdSessionContext(Context context, String avidAdSessionId2, String avidAdSessionType2, String mediaType2, ExternalAvidAdSessionContext avidAdSessionContext2) {
        AvidContext.getInstance().init(context);
        this.avidAdSessionId = avidAdSessionId2;
        this.avidAdSessionContext = avidAdSessionContext2;
        this.avidAdSessionType = avidAdSessionType2;
    ...
    public void setAvidAdSessionContext(ExternalAvidAdSessionContext avidAdSessionContext2) {
        this.avidAdSessionContext = avidAdSessionContext2;
    }
