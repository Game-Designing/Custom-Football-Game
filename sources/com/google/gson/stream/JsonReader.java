...
public class JsonReader implements Closeable {
    ...
    private final char[] buffer = new char[Opcodes.ACC_ABSTRACT];

    /* renamed from: in */
    private final Reader f30873in;
    ...
    static {
        C10160t.INSTANCE = new C10160t() {
            public void promoteNameToValue(JsonReader reader) throws IOException {
                if (reader instanceof C10110h) {
                    ((C10110h) reader).mo33298a();
                    return;
                }
                int p = reader.peeked;
                if (p == 0) {
    ...
    private int peekKeyword() throws IOException {
        ...
        if (c == 't' || c == 'T') {
            ...
            keyword = AdultContentAnalytics.UNLOCK;
            keywordUpper = "FALSE";
            peeking = 6;
        } else if (c != 'n' && c != 'N') {
            return 0;
