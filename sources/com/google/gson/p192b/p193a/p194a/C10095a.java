package com.google.gson.p192b.p193a.p194a;

import java.util.TimeZone;

/* renamed from: com.google.gson.b.a.a.a */
/* compiled from: ISO8601Utils */
public class C10095a {

    /* renamed from: a */
    private static final TimeZone f30668a = TimeZone.getTimeZone("UTC");
    ...
    public static java.util.Date m32929a(java.lang.String r23, java.text.ParsePosition r24) throws java.text.ParseException {
        /*
            r1 = r23
            r2 = r24
            java.lang.String r3 = "'"
            ...
            int r5 = r0 + 4
            int r0 = m32928a(r1, r0, r5)     // Catch:{ IndexOutOfBoundsException -> 0x022b, NumberFormatException -> 0x0226, IllegalArgumentException -> 0x0221 }
            r6 = 45
            boolean r7 = m32930a(r1, r5, r6)     // Catch:{ IndexOutOfBoundsException -> 0x022b, NumberFormatException -> 0x0226, IllegalArgumentException -> 0x0221 }
            if (r7 == 0) goto L_0x001b
            int r5 = r5 + 1
        L_0x001b:
            int r7 = r5 + 2
            int r5 = m32928a(r1, r5, r7)     // Catch:{ IndexOutOfBoundsException -> 0x022b, NumberFormatException -> 0x0226, IllegalArgumentException -> 0x0221 }
            boolean r8 = m32930a(r1, r7, r6)     // Catch:{ IndexOutOfBoundsException -> 0x022b, NumberFormatException -> 0x0226, IllegalArgumentException -> 0x0221 }
            if (r8 == 0) goto L_0x0029
            int r7 = r7 + 1
        L_0x0029:
            int r8 = r7 + 2
            int r7 = m32928a(r1, r7, r8)     // Catch:{ IndexOutOfBoundsException -> 0x022b, NumberFormatException -> 0x0226, IllegalArgumentException -> 0x0221 }
            r9 = 0
            r10 = 0
            r11 = 0
            r12 = 0
            r13 = 84
            boolean r13 = m32930a(r1, r8, r13)     // Catch:{ IndexOutOfBoundsException -> 0x022b, NumberFormatException -> 0x0226, IllegalArgumentException -> 0x0221 }
        ...
        L_0x005f:
            ...
            int r8 = r8 + 1
            int r6 = r8 + 2
            int r8 = m32928a(r1, r8, r6)     // Catch:{ IndexOutOfBoundsException -> 0x022b, NumberFormatException -> 0x0226, IllegalArgumentException -> 0x0221 }
            r9 = r8
            r8 = 58
            boolean r17 = m32930a(r1, r6, r8)     // Catch:{ IndexOutOfBoundsException -> 0x022b, NumberFormatException -> 0x0226, IllegalArgumentException -> 0x0221 }
            if (r17 == 0) goto L_0x0076
            int r6 = r6 + 1
        L_0x0076:
            int r14 = r6 + 2
            int r6 = m32928a(r1, r6, r14)     // Catch:{ IndexOutOfBoundsException -> 0x022b, NumberFormatException -> 0x0226, IllegalArgumentException -> 0x0221 }
            r10 = r6
            boolean r6 = m32930a(r1, r14, r8)     // Catch:{ IndexOutOfBoundsException -> 0x022b, NumberFormatException -> 0x0226, IllegalArgumentException -> 0x0221 }
        ...
        L_0x0088:
            ...
            if (r6 == r14) goto L_0x00e8
            int r14 = r8 + 2
            int r8 = m32928a(r1, r8, r14)     // Catch:{ IndexOutOfBoundsException -> 0x022b, NumberFormatException -> 0x0226, IllegalArgumentException -> 0x0221 }
            r11 = 59
        ...
        L_0x00af:
            r8 = 46
            boolean r8 = m32930a(r1, r14, r8)     // Catch:{ IndexOutOfBoundsException -> 0x022b, NumberFormatException -> 0x0226, IllegalArgumentException -> 0x0221 }
            if (r8 == 0) goto L_0x00e2
            int r14 = r14 + 1
            int r8 = r14 + 1
            int r8 = m32927a(r1, r8)     // Catch:{ IndexOutOfBoundsException -> 0x022b, NumberFormatException -> 0x0226, IllegalArgumentException -> 0x0221 }
            int r15 = r14 + 3
            ...
            int r19 = m32928a(r1, r14, r15)     // Catch:{ IndexOutOfBoundsException -> 0x022b, NumberFormatException -> 0x0226, IllegalArgumentException -> 0x0221 }
            r20 = r4
            int r4 = r15 - r14
            r21 = r6
            r6 = 1
        ...
        L_0x00f2:
            ...
            java.util.TimeZone r15 = f30668a     // Catch:{ IndexOutOfBoundsException -> 0x021f, NumberFormatException -> 0x021d, IllegalArgumentException -> 0x021b }
            r4 = r15
            r15 = 1
            int r8 = r8 + r15
            r18 = r6
        ...
        L_0x01d6:
            ...
            r21 = r8
        L_0x01dc:
            java.util.TimeZone r4 = f30668a     // Catch:{ IndexOutOfBoundsException -> 0x021f, NumberFormatException -> 0x021d, IllegalArgumentException -> 0x021b }
        L_0x01de:
            r8 = r21
        L_0x01e0:
        ...
        L_0x0272:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.gson.p192b.p193a.p194a.C10095a.m32929a(java.lang.String, java.text.ParsePosition):java.util.Date");
    }

    /* renamed from: a */
    private static boolean m32930a(String value, int offset, char expected) {
        return offset < value.length() && value.charAt(offset) == expected;
    }

    /* renamed from: a */
    private static int m32928a(String value, int beginIndex, int endIndex) throws NumberFormatException {
    ...
    /* renamed from: a */
    private static int m32927a(String string, int offset) {
