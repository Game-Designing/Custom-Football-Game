...
final class C9262Yp extends C9241Xp {
    C9262Yp() {
    }

    /* access modifiers changed from: 0000 */
    /* renamed from: a */
    public final int mo28699a(int i, byte[] bArr, int i2, int i3) {
        ...
        while (r9 < i3) {
            ...
            if (b >= 0) {
                ...
                if (i4 >= i3 - 1) {
                    return C9199Vp.m23157d(bArr, i4, i3);
                }
                int i5 = i4 + 1;
                byte b2 = bArr[i4];
    ...
    public final String mo28703b(byte[] bArr, int i, int i2) throws zzdok {
        if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
            ...
            while (r13 < i3) {
                byte b = bArr[r13];
                if (!C9220Wp.m23195d(b)) {
                    break;
                }
                i = r13 + 1;
                int i5 = i4 + 1;
                C9220Wp.m23192b(b, cArr, i4);
                i4 = i5;
            }
            int i6 = i4;
            while (r13 < i3) {
                int i7 = r13 + 1;
                byte b2 = bArr[r13];
                if (C9220Wp.m23195d(b2)) {
                    int i8 = i6 + 1;
                    C9220Wp.m23192b(b2, cArr, i6);
                    while (i7 < i3) {
                        byte b3 = bArr[i7];
                        if (!C9220Wp.m23195d(b3)) {
                            break;
                        }
                        i7++;
                        int i9 = i8 + 1;
                        C9220Wp.m23192b(b3, cArr, i8);
                        i8 = i9;
                    }
                    r13 = i7;
                    i6 = i8;
                } else if (C9220Wp.m23196e(b2)) {
                    if (i7 < i3) {
                        int i10 = i7 + 1;
                        int i11 = i6 + 1;
                        C9220Wp.m23191b(b2, bArr[i7], cArr, i6);
                        r13 = i10;
                        i6 = i11;
                    } else {
                        throw zzdok.m29935h();
                    }
                } else if (C9220Wp.m23197f(b2)) {
                    if (i7 < i3 - 1) {
                        int i12 = i7 + 1;
                        int i13 = i12 + 1;
                        int i14 = i6 + 1;
                        C9220Wp.m23190b(b2, bArr[i7], bArr[i12], cArr, i6);
                        r13 = i13;
                        i6 = i14;
                    } else {
                        throw zzdok.m29935h();
                    ...
                    int i17 = i16 + 1;
                    int i18 = i6 + 1;
                    C9220Wp.m23189b(b2, b4, bArr[i15], bArr[i16], cArr, i6);
                    r13 = i17;
                    i6 = i18 + 1;
                } else {
                    throw zzdok.m29935h();
