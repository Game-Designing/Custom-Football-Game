...
public class AdvertisingIdClient {
    ...
    private static BlockingServiceConnection zza(Context context, boolean z) throws IOException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        try {
            ...
            if (a == 0 || a == 2) {
                ...
                try {
                    if (ConnectionTracker.m22050a().mo27924a(context, intent, blockingServiceConnection, 1)) {
    ...
    private static zze zza(Context context, BlockingServiceConnection blockingServiceConnection) throws IOException {
        try {
            return zzf.m31638a(blockingServiceConnection.mo27272a(10000, TimeUnit.MILLISECONDS));
        } catch (InterruptedException e) {
    ...
    private final void zza(boolean z) throws IOException, IllegalStateException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        Preconditions.m21870c("Calling this from your main thread can lead to deadlock");
        synchronized (this) {
            if (this.zzg) {
                finish();
            }
    ...
    private final boolean zza(Info info, boolean z, float f, long j, String str, Throwable th) {
        ...
        hashMap.put(BundleCons.TAG, "AdvertisingIdClient");
    ...
    private final boolean zzb() throws IOException {
        ...
        synchronized (this) {
            ...
            Preconditions.m21857a(this.zze);
            Preconditions.m21857a(this.zzf);
            h = this.zzf.mo32402h();
        }
        zza();
        return h;
    ...
    public final void finish() {
        /*
            ...
            com.google.android.gms.common.internal.Preconditions.m21870c(r0)
            monitor-enter(r3)
        ...
        L_0x000f:
            ...
            com.google.android.gms.common.stats.ConnectionTracker r0 = com.google.android.gms.common.stats.ConnectionTracker.m22050a()     // Catch:{ Throwable -> 0x001f }
            ...
            r0.mo27923a(r1, r2)     // Catch:{ Throwable -> 0x001f }
            goto L_0x0027
        L_0x001f:
            r0 = move-exception
    ...
    public Info getInfo() throws IOException {
        ...
        synchronized (this) {
            ...
            Preconditions.m21857a(this.zze);
            Preconditions.m21857a(this.zzf);
            info = new Info(this.zzf.getId(), this.zzf.mo32403i(true));
        }
        zza();
        return info;
    }
