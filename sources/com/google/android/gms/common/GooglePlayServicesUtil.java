...
public final class GooglePlayServicesUtil extends GooglePlayServicesUtilLight {
    ...
    public static Dialog getErrorDialog(int i, Activity activity, int i2, OnCancelListener onCancelListener) {
        ...
        return GoogleApiAvailability.getInstance().mo27296a(activity, i, i2, onCancelListener);
    }
    ...
    public static boolean showErrorDialogFragment(int i, Activity activity, Fragment fragment, int i2, OnCancelListener onCancelListener) {
        ...
        if (fragment == null) {
            return instance.mo27304b(activity, i, i2, onCancelListener);
        }
        Dialog a = GoogleApiAvailability.m21068a((Context) activity, i, DialogRedirect.m21808a(fragment, GoogleApiAvailability.getInstance().mo27299a((Context) activity, i, "d"), i2), onCancelListener);
        if (a == null) {
            return false;
        }
        GoogleApiAvailability.m21070a(activity, a, GMS_ERROR_DIALOG, onCancelListener);
        return true;
    }
    ...
    public static void showErrorNotification(int i, Context context) {
        ...
        if (GooglePlayServicesUtilLight.isPlayServicesPossiblyUpdating(context, i) || GooglePlayServicesUtilLight.isPlayStorePossiblyUpdating(context, i)) {
            instance.mo27305c(context);
        } else {
            instance.mo27306c(context, i);
        }
    }
