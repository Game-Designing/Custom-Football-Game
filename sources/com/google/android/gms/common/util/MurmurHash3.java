...
public class MurmurHash3 {
    @KeepForSdk
    /* renamed from: a */
    public static int m22106a(byte[] bArr, int i, int i2, int i3) {
        int i4 = (i2 & -4) + i;
        while (i < i4) {
            int i5 = ((bArr[i] & 255) | ((bArr[i + 1] & 255) << 8) | ((bArr[i + 2] & 255) << ExecutionDataWriter.BLOCK_SESSIONINFO) | (bArr[i + 3] << 24)) * -862048943;
        ...
        if (i8 != 1) {
            if (i8 != 2) {
                if (i8 == 3) {
                    i7 = (bArr[i4 + 2] & 255) << ExecutionDataWriter.BLOCK_SESSIONINFO;
                }
                int i9 = i3 ^ i2;
