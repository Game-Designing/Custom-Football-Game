...
public class NetworkResponse {
    ...
    public NetworkResponse(int statusCode2, byte[] data2, Map<String, String> headers2, boolean notModified2, long networkTimeMs2) {
        this(statusCode2, data2, headers2, m38583a(headers2), notModified2, networkTimeMs2);
    }

    public NetworkResponse(int statusCode2, byte[] data2, boolean notModified2, long networkTimeMs2, List<Header> allHeaders2) {
        this(statusCode2, data2, m38584a(allHeaders2), allHeaders2, notModified2, networkTimeMs2);
    }
    ...
    public NetworkResponse(byte[] data2) {
        this(200, data2, false, 0, Collections.emptyList());
    }
    ...
    /* renamed from: a */
    private static Map<String, String> m38584a(List<Header> allHeaders2) {
        if (allHeaders2 == null) {
            return null;
        }
    ...
    /* renamed from: a */
    private static List<Header> m38583a(Map<String, String> headers2) {
        if (headers2 == null) {
            return null;
        }
        if (headers2.isEmpty()) {
        ...
        for (Entry<String, String> header : headers2.entrySet()) {
            allHeaders2.add(new Header((String) header.getKey(), (String) header.getValue()));
        }
        return allHeaders2;
    }
}
