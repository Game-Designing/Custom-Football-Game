...
/* renamed from: com.getkeepsafe.relinker.a.j */
/* compiled from: Section64Header */
public class C8064j extends C8057d {
    public C8064j(C8060f parser, C8055b header, int index) throws IOException {
        ByteBuffer buffer = ByteBuffer.allocate(8);
        buffer.order(header.f16412a ? ByteOrder.BIG_ENDIAN : ByteOrder.LITTLE_ENDIAN);
        this.f16425a = parser.mo24890e(buffer, header.f16415d + ((long) (header.f16418g * index)) + 44);
    }
}
