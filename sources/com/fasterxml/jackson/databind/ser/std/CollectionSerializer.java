...
public class CollectionSerializer extends AsArraySerializerBase<Collection<?>> {
    ...
    public ContainerSerializer<?> _withValueTypeSerializer(TypeSerializer vts) {
        CollectionSerializer collectionSerializer = new CollectionSerializer(this, this._property, vts, this._elementSerializer, this._unwrapSingle);
    ...
    public CollectionSerializer withResolved(BeanProperty property, TypeSerializer vts, JsonSerializer<?> elementSerializer, Boolean unwrapSingle) {
        CollectionSerializer collectionSerializer = new CollectionSerializer(this, property, vts, elementSerializer, unwrapSingle);
        return collectionSerializer;
    }
                ...
                try {
                    ...
                    if (elem == null) {
                        ...
                        if (typeSer == null) {
                            ...
                            serializerFor.serializeWithType(elem, g, provider, typeSer);
                        }
                    }
                    i++;
                } catch (Exception e) {
