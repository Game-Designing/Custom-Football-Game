...
public final class ConnectionSpec {
    ...
    public boolean isCompatible(SSLSocket socket) {
        ...
        String[] strArr = this.tlsVersions;
        if (strArr != null && !Util.nonEmptyIntersection(Util.NATURAL_ORDER, strArr, socket.getEnabledProtocols())) {
            return false;
        }
        String[] strArr2 = this.cipherSuites;
        if (strArr2 == null || Util.nonEmptyIntersection(CipherSuite.ORDER_BY_NAME, strArr2, socket.getEnabledCipherSuites())) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        sb.append(cipherSuitesString);
        sb.append(", tlsVersions=");
        sb.append(tlsVersionsString);
