...
final class DistinguishedNameParser {
    ...
    /* renamed from: dn */
    private final String f43236dn;
    private int end;
    private final int length = this.f43236dn.length();
    private int pos;

    DistinguishedNameParser(X500Principal principal) {
        this.f43236dn = principal.getName("RFC2253");
    }
    ...
    public String findMostSpecific(String attributeType) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f43236dn.toCharArray();
