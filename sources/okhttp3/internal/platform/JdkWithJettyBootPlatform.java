...
class JdkWithJettyBootPlatform extends Platform {
    ...
    public static Platform buildIfSupported() {
        ...
        try {
            ...
            sb.append(negoClassName);
            sb.append("$Provider");
            Class<?> providerClass = Class.forName(sb.toString());
            StringBuilder sb2 = new StringBuilder();
            sb2.append(negoClassName);
            sb2.append("$ClientProvider");
            Class<?> clientProviderClass2 = Class.forName(sb2.toString());
            StringBuilder sb3 = new StringBuilder();
            sb3.append(negoClassName);
            sb3.append("$ServerProvider");
            Class<?> serverProviderClass2 = Class.forName(sb3.toString());
            JdkWithJettyBootPlatform jdkWithJettyBootPlatform = new JdkWithJettyBootPlatform(negoClass.getMethod("put", new Class[]{SSLSocket.class, providerClass}), negoClass.getMethod("get", new Class[]{SSLSocket.class}), negoClass.getMethod("remove", new Class[]{SSLSocket.class}), clientProviderClass2, serverProviderClass2);
