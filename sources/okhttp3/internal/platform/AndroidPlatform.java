...
class AndroidPlatform extends Platform {
    ...
    public X509TrustManager trustManager(SSLSocketFactory sslSocketFactory) {
        ...
        Object context = Platform.readFieldOrNull(sslSocketFactory, this.sslParametersClass, str);
        if (context == null) {
            try {
                context = Platform.readFieldOrNull(sslSocketFactory, Class.forName("com.google.android.gms.org.conscrypt.SSLParametersImpl", false, sslSocketFactory.getClass().getClassLoader()), str);
    ...
    public static Platform buildIfSupported() {
        ...
        AndroidPlatform androidPlatform = new AndroidPlatform(cls, setUseSessionTickets2, setHostname2, optionalMethod2, optionalMethod);
