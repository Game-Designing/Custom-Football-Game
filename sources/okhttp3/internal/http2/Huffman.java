...
class Huffman {
    ...
    public void encode(p362h.C14195j r11, p362h.C14193h r12) throws java.io.IOException {
        /*
            r10 = this;
            r0 = 0
            r2 = 0
        ...
        L_0x0039:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.http2.Huffman.encode(h.j, h.h):void");
    }

    /* access modifiers changed from: 0000 */
    public int encodedLength(C14195j bytes) {
        long len = 0;
        for (int i = 0; i < bytes.mo44285s(); i++) {
            len += (long) CODE_LENGTHS[bytes.mo44270a(i) & 255];
        }
        return (int) ((7 + len) >> 3);
    }
