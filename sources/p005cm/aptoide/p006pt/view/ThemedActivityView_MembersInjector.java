...
public final class ThemedActivityView_MembersInjector implements C13183b<ThemedActivityView> {
    ...
    private static /* synthetic */ boolean[] $jacocoInit() {
        ...
        boolean[] probes = Offline.getProbes(-4926654829811420756L, "cm/aptoide/pt/view/ThemedActivityView_MembersInjector", 14);
        $jacocoData = probes;
        return probes;
    }
    ...
    public /* bridge */ /* synthetic */ void injectMembers(Object obj) {
        ...
        injectMembers((ThemedActivityView) obj);
        $jacocoInit[13] = true;
    }

    public ThemedActivityView_MembersInjector(Provider<AccountNavigator> accountNavigatorProvider2, Provider<String> marketNameProvider2, Provider<String> themeProvider2, Provider<AnalyticsManager> analyticsManagerProvider2, Provider<FirstLaunchAnalytics> firstLaunchAnalyticsProvider2) {
        boolean[] $jacocoInit = $jacocoInit();
    ...
    public static C13183b<ThemedActivityView> create(Provider<AccountNavigator> accountNavigatorProvider2, Provider<String> marketNameProvider2, Provider<String> themeProvider2, Provider<AnalyticsManager> analyticsManagerProvider2, Provider<FirstLaunchAnalytics> firstLaunchAnalyticsProvider2) {
        boolean[] $jacocoInit = $jacocoInit();
        ThemedActivityView_MembersInjector themedActivityView_MembersInjector = new ThemedActivityView_MembersInjector(accountNavigatorProvider2, marketNameProvider2, themeProvider2, analyticsManagerProvider2, firstLaunchAnalyticsProvider2);
        $jacocoInit[1] = true;
        return themedActivityView_MembersInjector;
    }

    public void injectMembers(ThemedActivityView instance) {
        boolean[] $jacocoInit = $jacocoInit();
    ...
    public static void injectTheme(ThemedActivityView instance, String theme) {
        boolean[] $jacocoInit = $jacocoInit();
