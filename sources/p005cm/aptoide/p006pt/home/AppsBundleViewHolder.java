...
/* renamed from: cm.aptoide.pt.home.AppsBundleViewHolder */
class AppsBundleViewHolder extends AppBundleViewHolder {
    ...
    private static /* synthetic */ boolean[] $jacocoInit() {
        ...
        boolean[] probes = Offline.getProbes(-2469210336106719477L, "cm/aptoide/pt/home/AppsBundleViewHolder", 24);
        $jacocoData = probes;
        return probes;
    }

    static /* synthetic */ C14963c access$000(AppsBundleViewHolder x0) {
    ...
    public AppsBundleViewHolder(View view, C14963c<HomeEvent> uiEventsListener2, DecimalFormat oneDecimalFormatter, String marketName2) {
        boolean[] $jacocoInit = $jacocoInit();
        super(view);
        ...
        $jacocoInit[3] = true;
        this.appsInBundleAdapter = new AppsInBundleAdapter(new ArrayList(), oneDecimalFormatter, uiEventsListener2);
        $jacocoInit[4] = true;
        ...
        this.appsList.mo7527a((C0980h) new C0980h(this) {
            private static transient /* synthetic */ boolean[] $jacocoData;
            final /* synthetic */ AppsBundleViewHolder this$0;
            ...
            private static /* synthetic */ boolean[] $jacocoInit() {
                ...
                boolean[] probes = Offline.getProbes(496857380538880630L, "cm/aptoide/pt/home/AppsBundleViewHolder$1", 3);
                $jacocoData = probes;
                return probes;
            }
        ...
        if (homeBundle instanceof AppBundle) {
            ...
            this.appsList.mo7530a((C0988n) new C0988n(this) {
                ...
                private static /* synthetic */ boolean[] $jacocoInit() {
                    ...
                    boolean[] probes = Offline.getProbes(5690921421949227266L, "cm/aptoide/pt/home/AppsBundleViewHolder$2", 7);
                    $jacocoData = probes;
                    return probes;
                }
                ...
                public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                    ...
                    if (dx <= 0) {
                        ...
                        $jacocoInit[2] = true;
                        C14963c access$000 = AppsBundleViewHolder.access$000(this.this$0);
                        HomeBundle homeBundle = homeBundle;
                        AppsBundleViewHolder appsBundleViewHolder = this.this$0;
                        $jacocoInit[3] = true;
                        HomeEvent homeEvent = new HomeEvent(homeBundle, appsBundleViewHolder.getAdapterPosition(), Type.SCROLL_RIGHT);
                        $jacocoInit[4] = true;
            ...
            $jacocoInit[18] = true;
            this.moreButton.setOnClickListener(new C3867i(this, homeBundle));
            $jacocoInit[19] = true;
            return;
        }
        $jacocoInit[10] = true;
    ...
    /* renamed from: a */
    public /* synthetic */ void mo14217a(HomeBundle homeBundle, View v) {
        boolean[] $jacocoInit = $jacocoInit();
