...
public final class WalletInstallActivity_MembersInjector implements C13183b<WalletInstallActivity> {
    ...
    private static /* synthetic */ boolean[] $jacocoInit() {
        ...
        boolean[] probes = Offline.getProbes(5541989293897367833L, "cm/aptoide/pt/wallet/WalletInstallActivity_MembersInjector", 14);
        $jacocoData = probes;
        return probes;
    }
    ...
    public WalletInstallActivity_MembersInjector(Provider<AccountNavigator> accountNavigatorProvider2, Provider<String> marketNameProvider2, Provider<String> themeProvider2, Provider<AnalyticsManager> analyticsManagerProvider2, Provider<FirstLaunchAnalytics> firstLaunchAnalyticsProvider2, Provider<WalletInstallPresenter> presenterProvider2) {
        boolean[] $jacocoInit = $jacocoInit();
    ...
    public static C13183b<WalletInstallActivity> create(Provider<AccountNavigator> accountNavigatorProvider2, Provider<String> marketNameProvider2, Provider<String> themeProvider2, Provider<AnalyticsManager> analyticsManagerProvider2, Provider<FirstLaunchAnalytics> firstLaunchAnalyticsProvider2, Provider<WalletInstallPresenter> presenterProvider2) {
        boolean[] $jacocoInit = $jacocoInit();
        WalletInstallActivity_MembersInjector walletInstallActivity_MembersInjector = new WalletInstallActivity_MembersInjector(accountNavigatorProvider2, marketNameProvider2, themeProvider2, analyticsManagerProvider2, firstLaunchAnalyticsProvider2, presenterProvider2);
        $jacocoInit[1] = true;
        return walletInstallActivity_MembersInjector;
    }

    public void injectMembers(WalletInstallActivity instance) {
        boolean[] $jacocoInit = $jacocoInit();
        ...
        $jacocoInit[10] = true;
        injectPresenter(instance, (WalletInstallPresenter) this.presenterProvider.get());
        $jacocoInit[11] = true;
    }

    public static void injectPresenter(WalletInstallActivity instance, WalletInstallPresenter presenter) {
        boolean[] $jacocoInit = $jacocoInit();
