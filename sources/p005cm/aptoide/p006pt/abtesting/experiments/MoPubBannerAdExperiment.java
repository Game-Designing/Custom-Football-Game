...
/* renamed from: cm.aptoide.pt.abtesting.experiments.MoPubBannerAdExperiment */
public class MoPubBannerAdExperiment {
    ...
    private static /* synthetic */ boolean[] $jacocoInit() {
        ...
        boolean[] probes = Offline.getProbes(5822192914713688116L, "cm/aptoide/pt/abtesting/experiments/MoPubBannerAdExperiment", 21);
        $jacocoData = probes;
        return probes;
    }

    public MoPubBannerAdExperiment(ABTestManager abTestManager2, MoPubAnalytics moPubAnalytics2) {
    ...
    public Single<Boolean> shouldLoadBanner() {
        ...
        C1385a aVar = new C1385a(this);
        $jacocoInit[2] = true;
        Single<Boolean> a = n.mo3688a((C0132p<? super T, ? extends Single<? extends R>>) aVar);
        $jacocoInit[3] = true;
        return a;
    }

    /* renamed from: a */
    public /* synthetic */ Single mo9535a(Experiment experiment) {
        boolean[] $jacocoInit = $jacocoInit();
