...
public final class ApplicationModule_ProvideBodyInterceptorPoolV7Factory implements C13181b<BodyInterceptor<BaseBody>> {
    ...
    public BodyInterceptor<BaseBody> get() {
        ...
        $jacocoInit[7] = true;
        BodyInterceptor<BaseBody> provideBodyInterceptorPoolV7 = applicationModule.provideBodyInterceptorPoolV7(authenticationPersistence, idsRepository, sharedPreferences, resources, qManager, str);
        $jacocoInit[8] = true;
        C13182c.m43111a(provideBodyInterceptorPoolV7, "Cannot return null from a non-@Nullable @Provides method");
        BodyInterceptor<BaseBody> bodyInterceptor = provideBodyInterceptorPoolV7;
        $jacocoInit[9] = true;
    ...
    public static C13181b<BodyInterceptor<BaseBody>> create(ApplicationModule module2, Provider<AuthenticationPersistence> authenticationPersistenceProvider2, Provider<IdsRepository> idsRepositoryProvider2, Provider<SharedPreferences> sharedPreferencesProvider2, Provider<Resources> resourcesProvider2, Provider<QManager> qManagerProvider2, Provider<String> aptoidePackageProvider2) {
        boolean[] $jacocoInit = $jacocoInit();
        ApplicationModule_ProvideBodyInterceptorPoolV7Factory applicationModule_ProvideBodyInterceptorPoolV7Factory = new ApplicationModule_ProvideBodyInterceptorPoolV7Factory(module2, authenticationPersistenceProvider2, idsRepositoryProvider2, sharedPreferencesProvider2, resourcesProvider2, qManagerProvider2, aptoidePackageProvider2);
        $jacocoInit[10] = true;
        return applicationModule_ProvideBodyInterceptorPoolV7Factory;
    }

    public static BodyInterceptor<BaseBody> proxyProvideBodyInterceptorPoolV7(ApplicationModule instance, AuthenticationPersistence authenticationPersistence, IdsRepository idsRepository, SharedPreferences sharedPreferences, Resources resources, QManager qManager, String aptoidePackage) {
        boolean[] $jacocoInit = $jacocoInit();
        BodyInterceptor<BaseBody> provideBodyInterceptorPoolV7 = instance.provideBodyInterceptorPoolV7(authenticationPersistence, idsRepository, sharedPreferences, resources, qManager, aptoidePackage);
        $jacocoInit[11] = true;
